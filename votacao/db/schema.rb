...
ActiveRecord::Schema.define(version: 2019_11_21_194738) do
  ...
  create_table "councilors", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "nome"
    t.string "telefone"
    t.bigint "city_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["city_id"], name: "index_councilors_on_city_id"
  end

  create_table "mayors", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "nome"
    t.string "email"
    t.bigint "city_id"
    t.datetime "created_at", null: false
